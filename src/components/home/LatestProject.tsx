...
const LatestProjects = () => {
    ...
    return (
        <div className='container max-w-6xl pb-5 my-10 font-custom'>
            <div className='w-full max-w-5xl m-auto'>
                <div className='mt-24 mx-0 -mb-24 space-y-20'>
                    ...
                    <div className="grid grid-cols-1  md:grid-cols-[60%,40%] gap-4 bg-gray-100 shadow-xl rounded-lg">
                    ...
                    <div className="grid grid-cols-1  md:grid-cols-[60%,40%] gap-4 bg-white-500 shadow-xl rounded-lg">
